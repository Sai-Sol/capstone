...
export const HARDCODED_USERS = [
  { name: "Admin User", email: "admin@quantumchain.io", password: "456", role: "admin", country: "United States" },
  { name: "Test User", email: "user@quantumchain.io", password: "123", role: "user", country: "Canada" },
];
